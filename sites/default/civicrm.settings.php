...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:rootjaki@localhost/db_comp?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:rootjaki@localhost:3306/db_comp?new_link=true');
  }
}
...
$civicrm_root = '/opt/lampp/htdocs/commerce/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/opt/lampp/htdocs/commerce/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/commerce/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '866c48b7f8c7870c64bff41b6b77d111');
}
...
// define( 'CIVICRM_MAIL_LOG', '/opt/lampp/htdocs/commerce/sites/default/files/civicrm/templates_c//mail.log');
// }
